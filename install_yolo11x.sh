...
# Downloads a pre-compiled YOLOv11x HEF model for Hailo-10H and installs
...
echo "=========================================================="
echo " YOLOv11x Model Setup for ${HAILO_ARCH} (v5.1.1 Compatible)"
echo "=========================================================="
